...
const WhatsAppFloat = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <a
        href="https://wa.me/41793654695"
        target="_blank"
        rel="noopener noreferrer"
        className="group flex items-center justify-center w-10 h-10 bg-green-500 hover:bg-green-600 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110"
