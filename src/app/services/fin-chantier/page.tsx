    ...
    <>
      ...
      <section className="section-swiss bg-main min-h-[70vh] flex flex-col justify-center">
        <div className="container-swiss">
          <h1 className="text-3xl md:text-4xl font-bold text-center mb-20 mt-4">{t.services.finChantier.title}</h1>
          ...
          <div className="flex flex-col md:flex-row items-center gap-20 mb-24 min-h-[340px] md:min-h-[420px]">
            <div className="flex-1 max-w-2xl">
              <h2 className="text-xl font-bold text-primary mb-2">{t.services.finChantier.blocks[0].h}</h2>
              <p className="text-secondary text-lg">{t.services.finChantier.blocks[0].p}</p>
            </div>
          ...
          >
            <div className="container-swiss flex flex-col md:flex-row-reverse items-center gap-20 p-12 min-h-[340px] md:min-h-[420px]">
              <div className="flex-1 max-w-2xl">
                <h2 className="text-xl font-bold text-primary mb-2">{t.services.finChantier.blocks[1].h}</h2>
                <p className="text-secondary text-lg">{t.services.finChantier.blocks[1].p}</p>
              </div>
              <div className="flex-1 flex justify-center max-w-2xl">
                <Image
          ...
          <div className="flex flex-col md:flex-row items-center gap-20 mb-24 min-h-[340px] md:min-h-[420px]">
            <div className="flex-1 max-w-2xl">
              <h2 className="text-xl font-bold text-primary mb-2">{t.services.finChantier.blocks[2].h}</h2>
              <p className="text-secondary text-lg">{t.services.finChantier.blocks[2].p}</p>
            </div>
            <div className="flex-1 flex justify-center max-w-2xl">
              <Image
